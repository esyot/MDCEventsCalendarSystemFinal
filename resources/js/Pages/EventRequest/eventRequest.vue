        ...
        <table class="w-full border">
            <thead>
                <tr class="bg-gray-300">
                    <th class="px-4 py-2 text-left text-center">Event Name</th>
                    ...
                    >
                        <div class="bg-white p-2 shadow-md rounded">
                            ...
                            <div class="flex justify-end p-2 space-x-1">
                                ...
                                <a
                                    :href="
                                        '/admin/event-delete/' + event.event_id
                                    "
                                    ...
                                    <button
                                        ...
                                        v-if="
                                            event.isApprovedByVenuCoordinator ==
                                                null && event.comment != null
                                        "
                                        @click="retractConfirm(event.event_id)"
                            ...
                            >
                                ...
                                <div class="flex items-start space-x-2">
                                    <textarea
                                        ...
                                        class="border h-20 shadow-inner w-full border-gray-300 rounded"
                                    ></textarea>
                                    <button
                                        class="px-4 py-2 bg-blue-500 text-blue-100 hover:opacity-50 rounded"
                                    >
