...
<div class="flex flex-grow p-6 space-x-2 overflow-y-auto h-screen" >
    ...
    <div class="flex w-[800px] flex-col bg-gray-100 rounded-xl border-2 border-gray-500">
      ...
      <div class="flex flex-col space-y-2">
        <div class="flex flex-col space-y-2 overflow-y-auto">
          <div
            ...
            @click="preview(event)"
            class="p-1 hover:opacity-50 cursor-pointer transition-transform duration-300 ease-in-out hover:scale-90"
          >
          <div class="flex p-2 space-x-2 items-center">
            ...
            <div class="flex flex-col">
              ...
              <span>{{ event.date }} at {{ formatTime(event.time_start) }} to {{ formatTime(event.time_end) }}</span>
            </div>
            <div  class="flex justify-end">
    <small>{{ timeAgo(event.isApprovedByAdmin) }}</small>
  </div>
          </div>
        </div>
